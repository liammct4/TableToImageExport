...
namespace TableToImageExport.TableContent
{
	...
	public class DateContent : ITableContent, ITextContent
	{
		...
		public string WriteContentToHtml(string resourcePath = null)
		{
			...
			return $"<p style=\"font-family: {Font.Name}; font-size: {Font.Size}px; {(Font.IsBold ? "font-weight: bold; " : "")}{(Font.IsItalic ? "font-style: italic; " : "")}color: rgb({colour.R}, {colour.G}, {colour.B});\">{Content.ToString(OutputFormat, Culture)}</p>";
		}
		/// <summary>
