...
namespace TableToImageExport.TableContent
{
	...
	public interface ITableContent
	{
		...
		void WriteContent(Graphics graphics, RectangleF position); // TODO: Convert to SkiaSharp.
		/// <summary>
		...
		SizeF GetContentSize(Graphics graphics = null, Size? sizeOfCell = null); // TODO: Convert to SkiaSharp.
	}
}
