...
namespace TableToImageExport.TableContent
{
	...
	public class TextContent : ITableContent, ITextContent
	{
		...
		public string WriteContentToHtml(string resourcePath = null)
		{
			...
			return $"<p style=\"font-family: {Font.Family.Name}; font-size: {Font.Size}px; {(Font.IsBold ? "font-weight: bold; " : "")}{(Font.IsItalic ? "font-style: italic; " : "")}color: rgb({colour.R}, {colour.G}, {colour.B});\">{Content}</p>";
		}
		/// <summary>
