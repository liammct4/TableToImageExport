...
namespace TableToImageExport
{
	...
	/// </summary>
	[Serializable]
	public class TableMismatchException<T> : Exception where T : Cell, new()
	{
		...
		/// </summary>
		public T MismatchedCell { get; internal set; }
		/// <summary>
		/// The table which had an attempt to add a cell to which belongs to another table.
		/// </summary>
		public Table<T> AttemptedTable { get; internal set; }
		...
		public TableMismatchException(T mismatchedCell, Table<T> attemptedTable, string message = DEFAULT_MESSAGE) : base(message)
		{
